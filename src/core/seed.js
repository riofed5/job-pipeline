...
export const SEED_RULES = [
  ...
  },
  {
    ...
    field: "title",
    match: "lead, principal, head of, director, staff engineer, architect, vp, chief, manager",
    action: "kill",
    enabled: true,
  ...
  },
  {
    ...
    field: "title",
    match: "sales, marketing, recruiter, talent acquisition, hr, account manager, designer, ux, customer success, support specialist, controller, accountant, legal, analyst, mechanical, electrical, communications, coordinator, partner, artist, investment, account executive",
    action: "kill",
    enabled: true,
    note: "",
  },
